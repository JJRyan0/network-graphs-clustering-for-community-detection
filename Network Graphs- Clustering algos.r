...
edges15 <- read.csv(file = getObjectStorageFileWithCredentials_a1e87d0737374c1f881a0e859f175a52("newscala", "edges15.csv"))
nodes15 <- read.csv(file = getObjectStorageFileWithCredentials_a1e87d0737374c1f881a0e859f175a52("newscala", "nodes15.csv"))
nodes14 <- read.csv(file = getObjectStorageFileWithCredentials_a1e87d0737374c1f881a0e859f175a52("newscala", "nodes14.csv"))   
edges14 <- read.csv(file = getObjectStorageFileWithCredentials_a1e87d0737374c1f881a0e859f175a52("newscala", "edges14.csv"))
